...
// age is optional
const Sample4 = (props: { who: string; age?: number }) => (
  <div>
    hello, {props.who} {props.age && `, your age is ${props.age}`}
  </div>
)
...
const Sample7 = ({ who, message = "hello" }: Sample6_Props) => (
  <div>
    <span>{message}</span>&nbsp;<span>{who.name}</span>
  </div>
)
